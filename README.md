...
3.  **[Servidor MQTT](https://github.com/ysuyzuysu/iepac-smaller/blob/main/mqtt.md):** Instruccions per configurar la Raspberry Pi per guardar les dades.
4.  3.  **[NodeRED](https://github.com/ysuyzuysu/iepaac-smaller/blob/main/install_nodered.md):** Instruccions per configurar **EN** la Raspberry Pi les instruccions.
